    ...
    if (testBegin("cmdBackup() online"))
    {
...

        {
            ...
            TEST_RESULT_STR_Z_KEYRPL(
                ...
                "\n"
                "[target:file]\n"
                "pg_data/PG_VERSION={\"checksum\":\"06d06bb31b570b94d7b4325f511f853dbe771c21\",\"pri\":true,\"size\":3"
                    ",\"timestamp\":1570000000}\n"
                "pg_data/global/pg_control={\"pri\":true,\"size\":8192,\"timestamp\":1570000000}\n"
                "pg_data/postgresql.conf={\"checksum\":\"e3db315c260e79211b7b52587123b7aa060f30ab\",\"pri\":true,\"size\":11"
                    ",\"timestamp\":1570000000}\n"
                "\n"
                "[target:path]\n"
                "pg_data={}\n"
...

        {
            ...
            TEST_RESULT_STR_Z_KEYRPL(
                ...
                "pg_data/PG_VERSION={\"checksum\":\"06d06bb31b570b94d7b4325f511f853dbe771c21\",\"pri\":true,\"size\":3"
                    ",\"timestamp\":1570000000}\n"
                "pg_data/global/pg_control={\"pri\":true,\"size\":8192,\"timestamp\":1570000000}\n"
                "pg_data/not-in-resume={\"checksum\":\"984816fd329622876e14907634264e6f332e9fb3\",\"pri\":true,\"size\":4"
                    ",\"timestamp\":1570100000}\n"
                "pg_data/pg_xlog/0000000105D95D3000000000={\"pri\":true,\"size\":16777216,\"timestamp\":1570100002}\n"
                "pg_data/postgresql.conf={\"checksum\":\"e3db315c260e79211b7b52587123b7aa060f30ab\",\"pri\":true,\"size\":11"
                    ",\"timestamp\":1570000000}\n"
                "pg_data/size-mismatch={\"checksum\":\"984816fd329622876e14907634264e6f332e9fb3\",\"pri\":true,\"size\":4"
                    ",\"timestamp\":1570100000}\n"
                "pg_data/time-mismatch={\"checksum\":\"984816fd329622876e14907634264e6f332e9fb3\",\"pri\":true,\"size\":4"
                    ",\"timestamp\":1570100000}\n"
                "pg_data/zero-size={\"pri\":true,\"size\":0,\"timestamp\":1570100000}\n"
                "\n"
                "[target:path]\n"
                "pg_data={}\n"
                "pg_data/global={}\n"
...

        {
            ...
            TEST_RESULT_STR_Z_KEYRPL(
                ...
                "\n"
                "[target:file]\n"
                "pg_data/PG_VERSION={\"checksum\":\"06d06bb31b570b94d7b4325f511f853dbe771c21\",\"pri\":true"
                    ",\"reference\":\"20191003-105320F\",\"size\":3,\"timestamp\":1570000000}\n"
                "pg_data/global/pg_control={\"pri\":true,\"reference\":\"20191003-105320F\",\"size\":8192"
                    ",\"timestamp\":1570000000}\n"
                "pg_data/postgresql.conf={\"checksum\":\"e3db315c260e79211b7b52587123b7aa060f30ab\",\"pri\":true"
                    ",\"reference\":\"20191003-105320F\",\"size\":11,\"timestamp\":1570000000}\n"
                "pg_data/resume-ref={\"pri\":true,\"size\":0,\"timestamp\":1570200000}\n"
                "pg_data/time-mismatch2={\"checksum\":\"984816fd329622876e14907634264e6f332e9fb3\",\"pri\":true,\"size\":4"
...

        {
            ...
            TEST_RESULT_STR_Z_KEYRPL(
                ...
                "\n"
                "[target:file]\n"
                "pg_data/PG_VERSION={\"checksum\":\"f5b7e6d36dc0113f61b36c700817d42b96f7b037\",\"pri\":true,\"size\":3"
                    ",\"timestamp\":1571200000}\n"
                "pg_data/backup_label={\"checksum\":\"8e6f41ac87a7514be96260d65bacbffb11be77dc\",\"pri\":true,\"size\":17"
                ...
                "pg_data/global/pg_control={\"pri\":true,\"size\":8192,\"timestamp\":1571200000}\n"
                "pg_data/pg_xlog/0000000105DA69C000000000={\"pri\":true,\"size\":16777216,\"timestamp\":1571200002}\n"
                "pg_data/postgresql.conf={\"checksum\":\"e3db315c260e79211b7b52587123b7aa060f30ab\",\"pri\":true,\"size\":11"
                    ",\"timestamp\":1570000000}\n"
                "\n"
                "[target:path]\n"
...

        {
            ...
            *(PageHeaderData *)(bufPtr(relation) + (PG_PAGE_SIZE_DEFAULT * 0x02)) = (PageHeaderData){.pd_upper = 0x00};
            ...
            TEST_RESULT_STR_Z_KEYRPL(
                ...
                "\n"
                "[target:file]\n"
                "pg_data/PG_VERSION={\"checksum\":\"17ba0791499db908433b80f37c5fbc89b870084b\",\"pri\":true,\"size\":2"
                ...
                "pg_data/base/1/3={\"checksum\":\"73e537a445ad34eab4b292ac6aa07b8ce14e8421\",\"checksum-page\":false"
                    ",\"checksum-page-error\":[0,[2,3]],\"size\":32768,\"timestamp\":1572200000}\n"
                "pg_data/base/1/4={\"checksum\":\"ba233be7198b3115f0480fa5274448f2a2fc2af1\",\"checksum-page\":false"
                    ",\"checksum-page-error\":[1],\"size\":24576,\"timestamp\":1572200000}\n"
                "pg_data/global/pg_control={\"pri\":true,\"size\":8192,\"timestamp\":1572200000}\n"
                "pg_data/pg_wal/0000000105DB5DE000000000={\"pri\":true,\"size\":1048576,\"timestamp\":1572200002}\n"
                "pg_data/pg_wal/0000000105DB5DE000000001={\"pri\":true,\"size\":1048576,\"timestamp\":1572200002}\n"
                "pg_data/pg_wal/0000000105DB5DE000000002={\"pri\":true,\"size\":1048576,\"timestamp\":1572200002}\n"
                "pg_data/postgresql.conf={\"checksum\":\"e3db315c260e79211b7b52587123b7aa060f30ab\",\"pri\":true,\"size\":11"
                    ",\"timestamp\":1570000000}\n"
...

        {
            ...
            TEST_RESULT_STR_Z_KEYRPL(
                ...
                "\n"
                "[target:file]\n"
                "pg_data/PG_VERSION={\"checksum\":\"17ba0791499db908433b80f37c5fbc89b870084b\",\"pri\":true"
                    ",\"reference\":\"20191027-181320F\",\"size\":2,\"timestamp\":1572200000}\n"
                "pg_data/backup_label={\"checksum\":\"8e6f41ac87a7514be96260d65bacbffb11be77dc\",\"pri\":true,\"size\":17"
                    ",\"timestamp\":1572400002}\n"
                "pg_data/global/pg_control={\"pri\":true,\"reference\":\"20191027-181320F\",\"size\":8192"
